...
<div class="paper-container">
  ...
  <div id="abstract1" class="abstract-box">
    <p>The non-fungible-token (NFT) market, long hailed for frictionless, gatekeeper-free trading, experienced a meteoric rise in 2021–2022 before collapsing abruptly in 2022-2023. To identify the forces behind this crash, we analyze 15 million on-chain transactions from 867 leading NFT collections. We estimate that wash trading, a fraudulent self-trade behavior designed to fabricate demand, generated approximately US $33 billion, or 47% of recorded trade volume, and was conducted by just 4% of addresses. We provide three key results as to <i>consequences</i> of wash trading. First, increases in wash-trade volume inflate performance metrics (trade count, trader count, capital inflow, and liquidity) during year 1, forming a speculative bubble. Second, the same activities are linked to significant declines across key performance metrics during year 2, crowding out genuine participation and eroding valuations. Third, these boom–bust dynamics are significantly dampened in collections characterized by a higher share of experienced traders, a larger proportion of long-horizon art collectors, and greater trader-network centrality, implying that informed or socially embedded participants buffer speculative shocks. We provide two key results as to <i>antecedents</i> of wash trading. First, we find that the introduction of speculative, volume-based token rewards (the &ldquo;Carrot&rdquo;) triggers an immediate and sustained surge in wash trading, as evidenced by the market response to Blur's airdrop campaigns. Second, we demonstrate that the abrupt removal of transaction barriers (the &ldquo;Broken Stick&rdquo;), specifically the elimination of platform fees and enforcement of creator royalties on OpenSea, leads to a sharp, opportunistic spike in artificial volume. Collectively, these findings suggest that wash traders operate as highly elastic, profit-maximizing agents, where both direct financial incentivization and transaction cost minimization serve as dominant predictors of market manipulation.</p>
