...
<div class="paper-container">
  <div class="paper-title-line">
    <b>(1) Carrot, Broken Stick, and Bubble: The Antecedents and Consequences of Wash Trading in NFT Markets</b>
  ...
  <div id="abstract1" class="abstract-box">
    <p>The non-fungible token (NFT) market, long hailed for its frictionless, gatekeeper-free trading, experienced a meteoric rise before collapsing abruptly. To identify the structural forces behind this crash, we analyze 15 million on-chain transactions across 867 leading collections. We reveal that wash trading—a fraudulent self-dealing mechanism designed to fabricate demand—generated approximately $33 billion (47% of recorded volume), despite being executed by just 4% of participating wallets. Utilizing Local Projections with Instrumental Variables (LP-IV), we document three key consequences of this manipulation. First, wash trades manufacture short-lived micro-bubbles by temporarily crowding in naive retail activity, inflating transaction volumes without generating lasting price discovery or fundamental liquidity. Second, this artificial activity ultimately crowds out genuine participation, triggering structural contractions in the organic user base and worsening peak-to-trough drawdowns. Third, we identify a "market immune system": these boom-and-bust dynamics are significantly dampened in collections with higher proportions of experienced investors, consumption-driven art collectors, and dense network centrality. Furthermore, we identify the structural antecedents of this manipulation. We demonstrate that platform-level growth strategies—specifically, the introduction of volume-based token rewards (the "carrot") and the aggressive elimination of transaction fees and creator royalties (the "broken stick") during marketplace wars—trigger explosive spikes in artificial volume. Collectively, our findings demonstrate that wash traders act as highly elastic, profit-maximizing Sybil attackers, suggesting that maintaining modest economic frictions is a vital firewall for preserving market integrity and overall welfare.</p>
    
    <p style="margin-top: 10px;">
      <strong>Keywords:</strong> Non-fungible Token (NFT); Market Manipulation; Market Bubble and Burst; Heterogeneous Effect; Platform Economics; Token Incentives; Transaction Costs
    </p>
  </div>
</div>
...
<div class="paper-container">
  ...
  <ul>
    ...
    <li>Revise and resubmit at <i>Information Systems Research</i></li>
